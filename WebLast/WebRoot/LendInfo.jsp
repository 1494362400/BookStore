  ...
  <body background="image/4.jpg">
    <div style="width:810px;margin:10px auto;line-height:40px;">
    	...
    	<%
    		...
    		if(content.equals("")==false)
    			...
    			if(loginMark.equals("admin")){
    				sql="select * from lendBook"+sqlWhere+" order by lendId";
    			}
    			else if(loginMark.equals("user")){
    				sql="select * from lendBook"+sqlWhere+" where userId='"+loginUserId+"' order by lendId";
    			}
    			rs=db.select(sql);
    	...
    	<table class="table_border table_border_bg table_hover"width="100%">
    		...
    		<%
    			String lendId,UserId,username,bookname,author,timeRenew,sign,isReturn="";
    			while(rs.next()){
    				lendId=rs.getString("lendId");
